        ...
        >
            <div class="flex flex-col xl:flex-row gap-24">
                <img
                    ...
                    src="http://localhost:8000/img/about.jpeg"
                    alt="about"
                />
                <div
                ...
                >
                    <div class="flex flex-col">
                        ...
                        <p class="mb-8">
                            I have 5 years of PHP programming experience and
                            good front-end programming skills. I want to develop
                            my programming abilities and skills as a programmer
                            in a professional working environment. Challenges at
                            work will give me effective troubleshooting skills,
                            perfect software products that meet customer
                            requirements, enhance the company brand and reach
                            higher positions in career
                        </p>
                        <hr class="mb-8 opacity-90 dark:opacity-5" />
                        <P class="mb-4 text-accent">PERSONAL INFORMATION</P>
                        <hr class="mb-8 opacity-90 dark:opacity-5" />
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                <h4
                                    class="mb-1 text-xl font-bold text-dark dark:text-white"
                                >
                                    My Location
                                </h4>
                                <p
                                ...
                                >
                                    60 C1, Phường 13, Quận Tân Bình, Thành phố
                                    Hồ Chí Minh
                                </p>
                            </div>
                        </div>
