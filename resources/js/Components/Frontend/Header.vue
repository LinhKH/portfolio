...
const setActive = (nav) => {
    active.value = router.page.url == '/' + nav.href ? 'active' : '';
}
...
<template>
    <nav class="w-full fixed z-20 border-gray-200 px-2 sm:px-4 py-2.5 rounded" :class="{
        ...
        <div class="container flex flex-wrap justify-between items-center mx-auto" bis_skin_checked="1">
            <a href="http://128.199.85.33/about" target="_blank"
                class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="../../../../public/img/logo2.png" class="mr-3 h-6 sm:h-9" alt="Linh Dev Logo" />
                <span style="font-family: cursive;"
                    class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Linh Dev</span>
            </a>
            ...
            <div class="w-full md:block md:w-auto" :class="{ hidden: showMobileMenu }" id="navbar-default"
                ...
                <ul
                    ...
                    <li v-for="(navigation, index) in navigations" :key="index" :class="active">
                        <a @click="setActive(navigation)" :href="navigation.href"
